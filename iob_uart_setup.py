...
[
    # Macros
    {'name':'DATA_W', 'type':'M', 'val':'32', 'min':'NA', 'max':'NA', 'descr':"Data bus width"},
    {'name':'ADDR_W', 'type':'M', 'val':'`IOB_UART_SWREG_ADDR_W', 'min':'NA', 'max':'NA', 'descr':"Address bus width"},
    {'name':'UART_DATA_W', 'type':'M', 'val':'8', 'min':'NA', 'max':'NA', 'descr':""},
    # Parameters
