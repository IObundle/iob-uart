...
[
    {'name': 'uart', 'descr':'UART software accessible registers.', 'regs': [
        ...
        {'name':"TXEN", 'type':"W", 'n_bits':1, 'rst_val':0, 'addr':4, 'n_items':1, 'autologic':True, 'descr':"TX enable."},
        {'name':"TXREADY", 'type':"R", 'n_bits':1, 'rst_val':0, 'addr':5, 'n_items':1, 'autologic':True, 'descr':"TX ready to receive data."},
        {'name':"RXDATA", 'type':"R", 'n_bits':'UART_DATA_W', 'rst_val':0, 'addr':6, 'n_items':1, 'autologic':True, 'descr':"RX data."},
        {'name':"RXEN", 'type':"W", 'n_bits':1, 'rst_val':0, 'addr':8, 'n_items':1, 'autologic':True, 'descr':"RX enable."},
        {'name':"RXREADY", 'type':"R", 'n_bits':1, 'rst_val':0, 'addr':9, 'n_items':1, 'autologic':True, 'descr':"RX data is ready to be read."}
    ]}
]
